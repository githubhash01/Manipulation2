...
{
  new (message_memory) cw2_world_spawner::srv::TaskSetup_Request(_init);
}

void TaskSetup_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cw2_world_spawner::srv::TaskSetup_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TaskSetup_Request_message_member_array[1] = {
  {
    ...
    offsetof(cw2_world_spawner::srv::TaskSetup_Request, task_index),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TaskSetup_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(cw2_world_spawner::srv::TaskSetup_Request),
...
{
  return &::cw2_world_spawner::srv::rosidl_typesupport_introspection_cpp::TaskSetup_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cw2_world_spawner, srv, TaskSetup_Request)() {
  return &::cw2_world_spawner::srv::rosidl_typesupport_introspection_cpp::TaskSetup_Request_message_type_support_handle;
}
...
void TaskSetup_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) cw2_world_spawner::srv::TaskSetup_Response(_init);
}

void TaskSetup_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cw2_world_spawner::srv::TaskSetup_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TaskSetup_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cw2_world_spawner::srv::TaskSetup_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TaskSetup_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(cw2_world_spawner::srv::TaskSetup_Response),
...
{
  return &::cw2_world_spawner::srv::rosidl_typesupport_introspection_cpp::TaskSetup_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cw2_world_spawner, srv, TaskSetup_Response)() {
  return &::cw2_world_spawner::srv::rosidl_typesupport_introspection_cpp::TaskSetup_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers TaskSetup_service_members = {
  ...
  // see get_service_type_support_handle<cw2_world_spawner::srv::TaskSetup>()
...
get_service_type_support_handle<cw2_world_spawner::srv::TaskSetup>()
{
  ...
  auto service_type_support =
    &::cw2_world_spawner::srv::rosidl_typesupport_introspection_cpp::TaskSetup_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cw2_world_spawner, srv, TaskSetup)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<cw2_world_spawner::srv::TaskSetup>();
}
