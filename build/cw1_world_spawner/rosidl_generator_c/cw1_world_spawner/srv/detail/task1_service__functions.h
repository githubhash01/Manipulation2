...
#ifndef CW1_WORLD_SPAWNER__SRV__DETAIL__TASK1_SERVICE__FUNCTIONS_H_
#define CW1_WORLD_SPAWNER__SRV__DETAIL__TASK1_SERVICE__FUNCTIONS_H_
 ...
 * calls
 * cw1_world_spawner__srv__Task1Service_Request__init().
...
/**
 * It calls
 * cw1_world_spawner__srv__Task1Service_Request__fini()
 ...
 * cw1_world_spawner__srv__Task1Service_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * cw1_world_spawner__srv__Task1Service_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cw1_world_spawner__srv__Task1Service_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cw1_world_spawner
...
/**
 * It calls
 * cw1_world_spawner__srv__Task1Service_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cw1_world_spawner
...
/**
 * It allocates the memory for the array and calls
 * cw1_world_spawner__srv__Task1Service_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cw1_world_spawner
...
/**
 * It calls
 * cw1_world_spawner__srv__Task1Service_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CW1_WORLD_SPAWNER__SRV__DETAIL__TASK1_SERVICE__FUNCTIONS_H_
