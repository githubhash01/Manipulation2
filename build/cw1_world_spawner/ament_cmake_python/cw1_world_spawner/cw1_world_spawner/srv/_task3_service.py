...
class Metaclass_Task3Service(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cw1_world_spawner.srv.Task3Service')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from cw1_world_spawner.srv import _task3_service
...
class Task3Service(metaclass=Metaclass_Task3Service):
    from cw1_world_spawner.srv._task3_service import Task3Service_Request as Request
    from cw1_world_spawner.srv._task3_service import Task3Service_Response as Response
