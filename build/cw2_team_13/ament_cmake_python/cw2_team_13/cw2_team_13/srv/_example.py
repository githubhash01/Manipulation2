...
class Metaclass_Example_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('cw2_team_13')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Example(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cw2_team_13.srv import _example
...
class Example(metaclass=Metaclass_Example):
    from cw2_team_13.srv._example import Example_Request as Request
    from cw2_team_13.srv._example import Example_Response as Response
