...
#include "cw2_team_13/srv/detail/example__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cw2_team_13::srv::Example_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cw2_team_13::srv::Example_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cw2_team_13::srv::Example_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_cw2_team_13
const rosidl_message_type_support_t *
get_message_type_support_handle<cw2_team_13::srv::Example_Request>()
{
  return &cw2_team_13::srv::typesupport_fastrtps_cpp::_Example_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cw2_team_13::srv::Example_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cw2_team_13::srv::Example_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cw2_team_13::srv::Example_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cw2_team_13::srv::typesupport_fastrtps_cpp::_Example_Response__handle;
}
...
{
  return &cw2_team_13::srv::typesupport_fastrtps_cpp::_Example__handle;
}
