...
#include "cw2_world_spawner/srv/detail/task2_service__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point_stamped__functions.h"  // mystery_object_point, ref_object_points
...
using _Task2Service_Request__ros_msg_type = cw2_world_spawner__srv__Task2Service_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: ref_object_points
  {
    ...
    auto array_ptr = ros_message->ref_object_points.data;
  ...
  // Field name: mystery_object_point
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->mystery_object_point, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: ref_object_points
  {
    ...
    if (ros_message->ref_object_points.data) {
      geometry_msgs__msg__PointStamped__Sequence__fini(&ros_message->ref_object_points);
    }
    if (!geometry_msgs__msg__PointStamped__Sequence__init(&ros_message->ref_object_points, size)) {
      fprintf(stderr, "failed to create array for field 'ref_object_points'");
      return false;
    }
    auto array_ptr = ros_message->ref_object_points.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_cw2_world_spawner__srv__Task2Service_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Task2Service_Request__ros_msg_type * ros_message = static_cast<const _Task2Service_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Task2Service_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cw2_world_spawner__srv__Task2Service_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cw2_world_spawner
size_t max_serialized_size_cw2_world_spawner__srv__Task2Service_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cw2_world_spawner__srv__Task2Service_Request;
    is_plain =
      (
...
static size_t _Task2Service_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cw2_world_spawner__srv__Task2Service_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cw2_world_spawner, srv, Task2Service_Request)() {
...
using _Task2Service_Response__ros_msg_type = cw2_world_spawner__srv__Task2Service_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cw2_world_spawner
size_t get_serialized_size_cw2_world_spawner__srv__Task2Service_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Task2Service_Response__ros_msg_type * ros_message = static_cast<const _Task2Service_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_cw2_world_spawner__srv__Task2Service_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cw2_world_spawner
size_t max_serialized_size_cw2_world_spawner__srv__Task2Service_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cw2_world_spawner__srv__Task2Service_Response;
    is_plain =
      (
...
static size_t _Task2Service_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cw2_world_spawner__srv__Task2Service_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cw2_world_spawner, srv, Task2Service_Response)() {
...
// already included above
// #include "cw2_world_spawner/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "cw2_world_spawner/srv/task2_service.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cw2_world_spawner, srv, Task2Service)() {
