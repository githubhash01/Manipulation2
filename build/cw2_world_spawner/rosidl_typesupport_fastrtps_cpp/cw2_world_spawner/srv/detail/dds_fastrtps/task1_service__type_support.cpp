...
#include "cw2_world_spawner/srv/detail/task1_service__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cw2_world_spawner::srv::Task1Service_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cw2_world_spawner::srv::Task1Service_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cw2_world_spawner::srv::Task1Service_Request *>(
    untyped_ros_message);
...
{
  return &cw2_world_spawner::srv::typesupport_fastrtps_cpp::_Task1Service_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cw2_world_spawner::srv::Task1Service_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cw2_world_spawner::srv::Task1Service_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cw2_world_spawner::srv::Task1Service_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cw2_world_spawner::srv::typesupport_fastrtps_cpp::_Task1Service_Response__handle;
}
...
{
  return &cw2_world_spawner::srv::typesupport_fastrtps_cpp::_Task1Service__handle;
}
