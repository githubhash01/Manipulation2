...
class Task2Service_Request(metaclass=Metaclass_Task2Service_Request):
    ...
    _fields_and_field_types = {
        'ref_object_points': 'sequence<geometry_msgs/PointStamped>',
        'mystery_object_point': 'geometry_msgs/PointStamped',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.ref_object_points = kwargs.get('ref_object_points', [])
        from geometry_msgs.msg import PointStamped
        self.mystery_object_point = kwargs.get('mystery_object_point', PointStamped())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.ref_object_points != other.ref_object_points:
            return False
        if self.mystery_object_point != other.mystery_object_point:
            return False
        return True
    ...
    @builtins.property
    def ref_object_points(self):
        """Message field 'ref_object_points'."""
        return self._ref_object_points

    @ref_object_points.setter
    def ref_object_points(self, value):
        if __debug__:
            from geometry_msgs.msg import PointStamped
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'ref_object_points' field must be a set or sequence and each value of type 'PointStamped'"
        self._ref_object_points = value

    @builtins.property
    def mystery_object_point(self):
        """Message field 'mystery_object_point'."""
        return self._mystery_object_point

    @mystery_object_point.setter
    def mystery_object_point(self, value):
        if __debug__:
            from geometry_msgs.msg import PointStamped
            assert \
                isinstance(value, PointStamped), \
                "The 'mystery_object_point' field must be a sub message of type 'PointStamped'"
        self._mystery_object_point = value
...
class Task2Service_Response(metaclass=Metaclass_Task2Service_Response):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.mystery_object_num = kwargs.get('mystery_object_num', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.mystery_object_num != other.mystery_object_num:
            return False
        return True
    ...
    @builtins.property
    def mystery_object_num(self):
        """Message field 'mystery_object_num'."""
        return self._mystery_object_num

    @mystery_object_num.setter
    def mystery_object_num(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'mystery_object_num' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'mystery_object_num' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._mystery_object_num = value
...
class Metaclass_Task2Service(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cw2_world_spawner.srv.Task2Service')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from cw2_world_spawner.srv import _task2_service
...
class Task2Service(metaclass=Metaclass_Task2Service):
    from cw2_world_spawner.srv._task2_service import Task2Service_Request as Request
    from cw2_world_spawner.srv._task2_service import Task2Service_Response as Response
